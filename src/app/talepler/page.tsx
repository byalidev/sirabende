    ...
    <div className="requests-page">
      ...
      <main>
        <section className="requests-page-hero">
          <Container>
            <span className="eyebrow" style={{ color: "var(--lime)" }}>Canlı talepler</span>
            <h1>İnsanlar ne arıyor?</h1>
            <p>Talebini karşılayabilecek bir ihtiyaç bul ve doğru kişiye teklifini ulaştır.</p>
          </Container>
        </section>
        <Container>
          <section className="request-list-shell">
            <AiSearchForm categoryNames={categoryNames} />
            <details className="request-filter-panel">
              <summary>Filtreler <span>⌄</span></summary>
              <RequestFilterForm categories={categories} locations={locations} initial={filters} conditionLabels={conditionLabels} dateLabels={dateLabels} sortLabels={sortLabels} />
            </details>
            {recommended.length ? (
